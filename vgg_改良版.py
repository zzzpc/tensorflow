...
train_filename = ['/input/cifar10/qk_07_010_1.txt', '/input/cifar10/qk_07_010_2.txt', '/input/cifar10/qk_07_010_3.txt',
                  '/input/cifar10/qk_07_010_4.txt', '/input/cifar10/qk_07_010_5.txt']
...
test_filename = ['/input/cifar10/qk_07_010_test.txt']
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        for ep in range(epochs):
            ...
            if ep>=50:
                if ep%10==0:
                     saver.save(sess,'/data/data/model_%d.ckpt' %ep)
        """
        for ep in range(epochs):
            acc = 0
