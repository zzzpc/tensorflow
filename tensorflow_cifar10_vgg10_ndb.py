...
train_filename=['/input/cifar10_5/cifar10_1.txt','/input/cifar10_5/cifar10_2.txt','/input/cifar10_5/cifar10_3.txt','/input/cifar10_5/cifar10_4.txt','/input/cifar10_5/cifar10_5.txt']

test_filename=['/input/cifar10_5/cifar10_test.txt']
...
conv1_1 = conv_wrapper(result_x_images,'conv1_1',True,64)
